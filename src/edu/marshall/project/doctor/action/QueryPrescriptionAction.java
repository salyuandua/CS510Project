...
public class QueryPrescriptionAction implements Action<String>{
	...
	public String excute(Map<String, Object> param) {
		...
		String sql="select pre.*,p.patient_id,if(p.patient_name_mid is null,concat(p.patient_name_first,' ',p.patient_name_last),concat(p.patient_name_first,' ',p.patient_name_mid,p.patient_name_last)) as patient_name,g.gender_name"
